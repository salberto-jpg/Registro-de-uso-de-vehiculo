          ...
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <div className="flex items-center gap-6">
                <div className="flex flex-col">
                    <h1 className="text-2xl font-bold text-slate-900 tracking-tight">FleetTrack</h1>
                      ...
                      <tbody className="bg-white divide-y divide-slate-200">
                        {logs.length === 0 && !fetchError ? (
                          ...
                          <tr key={log.id} className="hover:bg-slate-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">{new Date(log.startTime).toLocaleDateString()} <span className="text-xs text-slate-400">{new Date(log.startTime).toLocaleTimeString()}</span></td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-500">
                              ...
                              ) : <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">En curso</span>}
                            </td>
              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form onSubmit={handleSaveUser}>
                    <div className="space-y-5">
                        ...
                        {userError && <p className="text-red-500 text-sm font-medium bg-red-50 p-2 rounded">{userError}</p>}
